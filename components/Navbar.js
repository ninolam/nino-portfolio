...
const Navbar = () => {
  ...
  const genericBurgerMenuLine = "w-8 h-0.5 bg-gray-600 transition ease transform duration-300 "
  ...
  return (
    <div className="bg-white dark:bg-gray-800 fixed w-full right-0 left-0 top-0 z-50 mx-auto px-4 py-10 md:py-12">
      <div className="flex  md:flex-row justify-between items-center max-w-6xl m-auto">
        ...
        <div className="space-x-4 flex flex-row items-center">
          <a target="_blank" href={userData.socialLinks.github} className="text-base font-normal text-gray-600 dark:text-gray-300 hidden md:inline-block">
          ...
          <a
            ...
            className="text-base font-normal text-gray-600 dark:text-gray-300 hidden md:inline-block"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="16"
